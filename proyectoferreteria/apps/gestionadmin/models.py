...
def validarnegativos(value):
    ...
    if value>1000000000:
        raise ValidationError('El número no puede ser superior a 100')
...
class Proveedor (models.Model):
    ...
    Correo_Proveedor=models.EmailField(verbose_name='Correo',max_length=30,null=True,blank=True, validators=[validarcorreoexistenteProveedor])
...
class Garantia (models.Model):
    ...
    Descripcion_Garantia=models.TextField(verbose_name='Descripción',max_length=30,validators=[validarnombre])
    Tiempo_Garantia_Mes=models.IntegerField(verbose_name='Tiempo garantía por mes')
...
class MetodoPago(models.Model):
    ...
    descripcionMetodoPago=models.TextField(verbose_name='Descripción',max_length=30, validators=[validarnombre])
    def __str__(self):
...
class Cliente(models.Model):
    ...
    Correo_Cliente=models.EmailField(verbose_name='Correo',max_length=30,null=True,blank=True,validators=[validarcorreoexistenteCliente])
...
class Factura(models.Model):
    ...
    Numero_Sar=models.CharField(verbose_name='Número de la SAR',max_length=15, default='004-340-345KN')
    #Para presentarse no puede ser ManyToManyField
    Id_producto=models.ManyToManyField(Producto, verbose_name='Producto')
    Fecha=models.DateTimeField(auto_now_add=True)
    Codigo_CAI=models.CharField(max_length=35, verbose_name='Código CAI',  default='114-560-345KJ')
